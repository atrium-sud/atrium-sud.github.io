...
tarteaucitron.services.matomo = {
    ...
    "js": function () {
        ...
        if(tarteaucitron.user.matomoEtabUniqueId){
        	window._paq.push(["addTracker", tarteaucitron.user.matomoHost + 'piwik.php', tarteaucitron.user.matomoEtabUniqueId]);
        }
        window._paq.push(["setSiteId", tarteaucitron.user.matomoId]);
        window._paq.push(["setTrackerUrl", tarteaucitron.user.matomoHost + "piwik.php"]);
        window._paq.push(['setCustomDimension', '1', tarteaucitron.user.matomoEspace]);
        window._paq.push(['setCustomDimension', '2',  tarteaucitron.user.matomoProfil]);
        window._paq.push(['setCustomDimension', '7',  tarteaucitron.user.matomoService]);
        window._paq.push(['setCustomDimension', '4',  tarteaucitron.user.matomoOrganisme]);
        window._paq.push(['setUserId', tarteaucitron.user.matomoUserid]);
        window._paq.push(["setDoNotTrack", 1]);
        if(tarteaucitron.user.matomoPageAnonymisee){
        	window._paq.push(['setCustomUrl', tarteaucitron.user.matomoPageAnonymisee]);
        }else {
        ...
        window.goToOutboundlink=function (url,name) {
	            if (tarteaucitron.user.matomoId === undefined) {
	                return;
	            }
	            ...
	            window._paq.push(['setCustomDimension', '7',  tarteaucitron.user.matomoService]);
	            window._paq.push(['setCustomDimension', '4',  tarteaucitron.user.matomoOrganisme]);
	            window._paq.push(['setCustomDimension', '5',  name]);
	            window._paq.push(['setUserId', tarteaucitron.user.matomoUserid]);
	            window._paq.push(["setDoNotTrack", 1]);
